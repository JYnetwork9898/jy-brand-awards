...
const Press: React.FC = () => {
    const articles = [
        {
            source: '중앙일보',
            title: '2025 KBMJ 브랜드 어워즈 성료... 45개 기업 수상',
            date: '2025.12.20',
            excerpt: '국내 최고의 브랜드 축제인 KBMJ 브랜드 어워즈가 지난 18일 성황리에 막을 내렸다. 이번 시상식에서는...',
            link: '#'
        },
        {
            source: '동아일보',
            title: '소비자가 뽑은 올해의 브랜드, KBMJ 어워즈에서 발표',
            date: '2025.09.15',
            excerpt: '소비자 만족도 조사를 기반으로 선정된 올해의 우수 브랜드들이 KBMJ 어워즈를 통해 공개되었다.',
            link: '#'
        },
        {
            source: '기업경영저널',
            title: 'KBMJ 어워즈 수상 기업, 전년 대비 매출 150% 성장',
            date: '2025.06.10',
        ...
        {
            source: '중앙일보',
            title: '2026 KBMJ 브랜드 어워즈, 참가 기업 모집 시작',
            date: '2026.01.02',
            ...
            <div className="max-w-7xl mx-auto px-8">
                <div className="text-center mb-16">
                    ...
                    <p className="text-gray-400 text-lg">
                        언론이 주목하는 KBMJ BRAND AWARDS의 소식을 전해드립니다.
                    </p>
                </div>
