  ...
  <body>
    ...
    <div class="hd_wrap">
      <div class="topnav" id="myTopnav">
        <a href="index.jsp" class="active"><img src="/marketing/images/logo.png"></a>
    ...
    <div id="quick_contact"
      class="w-layout-layout quick_contact w-node-a39eaea3-04d3-4195-f606-312ede815d74-af48ceb0 wf-layout-layout">
      <div id="w-node-_9507c949-60d9-fac2-2800-29e62a4e4187-af48ceb0" class="w-layout-cell quick_container">
        ...
        <div class="w-form">
          <form id="wf-form-q_contact" name="wf-form-q_contact" data-name="q_contact" method="post" class="form"
            action="quick_send.php">
            <input type="text" class="text-field w-input" maxlength="256" name="company_name" data-name="company_name"
              placeholder="기업명" id="company_name" required="">
            <input type="text" class="text-field-2 w-input" maxlength="256" name="company_emp" data-name="company_emp"
              placeholder="담당자명" id="company_emp-2" required="">
            <input type="tel" class="text-field-3 w-input" maxlength="256" name="company_phone"
              data-name="company_phone" placeholder="연락처" id="company_phone" required="">
            <input type="text" class="text-field-2 w-input" maxlength="256" name="company_mail" data-name="company_mail"
              placeholder="Email" id="company_mail" required="">
            ...
            <div class="columns w-row">
              <div id="contact-_agree" class="contact-_agree w-col w-col-8"><label
                  class="w-checkbox checkbox-field"><input type="checkbox" name="privacy_agree" value="동의"
                    data-name="개인정보 이용동의" required="" checked="" id="checkbox" class="w-checkbox-input"><span
                    class="checkbox-label w-form-label">[필수]정보이용동의</span></label>
                <label class="w-checkbox checkbox-field"><input type="checkbox" name="marketing_agree" value="동의"
                    data-name="마케팅이용동의" checked="" id="checkbox" class="w-checkbox-input"><span
                    class="checkbox-label w-form-label">[선택]마케팅동의</span></label>
              </div>
              <div class="column-2 w-clearfix w-col w-col-4">
                <a href="#" class="button-2 w-button" onClick="javascript:popOpen();">약관보기</a>
              </div>
            </div><input type="submit" value="빠른상담신청" data-wait="전송중입니다." class="submit_contact w-button"
        ...
        <h6 class="heading"><span class="text-span-3"></span><span> </span> <span id="contact_number"
            class="contact_number"><a href="tel:0269526443" style="color:#1b1b1b">02-6952-6443</span></a></span></h6>
        <h6 class="heading"><span class="mobile_kakao"></span><span> </span><span id="contact_kakao"
            class="contact_kakao"><a href="https://pf.kakao.com/_xlqakC" style="color:#1b1b1b">카카오톡 상담</span></a></span>
        </h6>
        <h6 class="heading"><span class="text-span-5"></span><span id="contact_mail" class="contact_mail">
            dellycoo<br>@jynetwork.co.kr</span></h6>
      </div>
    </div>
    <div id="w-node-fc421c20-676f-9a3d-8bd1-a649f0b16564-af48ceb0"
      class="w-layout-layout mobile_quick wf-layout-layout">
    ...
    <script src="https://d3e54v103j8qbb.cloudfront.net/js/jquery-3.5.1.min.dc5e7f18c8.js?site=646b08af3f5cc176af48ce90"
...
//-->
    ...
    <div class="modal-wrap">
      <h3 style="float:left;">개인정보 이용약관</h3><button class="modal-close" onClick="javascript:popClose();"
        style="float:right; background: #000; padding: 5px 10px; color: #fff; border-radius: 23px;">Close</button>
      <p style="float:left;">‘주식회사 제이와이네트워크’는 (이하 ‘회사’) 회사가 운영하는 서비스 상품에 대하여 이용하는 이용자님들의 개인정보를 중요시하며, 아래와 같은 개인정보취급방침을
        가지고 있습니다.<br>
        이 개인정보 취금방침은 ‘정보통신망 이용촉진 및 정보보호 등에 관한 법률’, 개인정보 보호법’ 및 ‘전자 등에서의 소비자 보호에 관한 법률’ 등 개인정보와 관련된 법령 상의 개인정보보호규정과
        방송통신위원회 및 안정행정부 등 관계부처가 제정한 가이드라인을 준수하고 있습니다. 본 개인정보취급방침은 당사의 서비스에 적용되며 다음과 같은 내용을 담고 있습니다.<br>
        회사는 이용자의 개인정보를 수집/이용/제공하는 경우 반드시 사전에 이용자에게 해당 내용을 알리고 동의 절차를 거치며, 이용자가 동의하지 않을 경우에는 이용자의 개인정보를 수집/이용/제공하지
        않습니다.<br>
