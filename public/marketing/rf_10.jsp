  ...
  <body>
    <div class="wrap">
      ...
      <div class="sub_area rf_div">
        ...
        <div class="rf_con">
          <div class="rf_logo"><img src="images/logo_rf10.jpg"></div>
          <div class="rf_top">
            <img src="images/img_rf10.jpg">
            <div class="rf_name">
              CALT
            </div>
          </div>
          ...
          <div class="rf_bot">
            <div class="rf_left">
              <div class="slick">
                <div><img src="images/rf10-1.jpg"></div>
                <div><img src="images/rf10-2.jpg"></div>
                <div><img src="images/rf10-3.jpg"></div>
              </div>
            </div>
            <div class="rf_right">
              <table>
