  ...
  <body>
    <div class="wrap">
      ...
      <div class="content">
        ...
        <div class="sec1">
          ...
          <div class="sec1_4box" data-aos="zoom-in">
            <ul>
              ...
              <li><a href="https://jy-media.co.kr/default/product/sub3.php?top=3&sub=3" target="_blank">영상제작<br>레퍼런스</a></li>
        ...
        <div class="sec2">
          <img src="images/bau_text.png" data-aos="zoom-in" class="sec2_img1">
          <img src="images/bau_img.png" data-aos="zoom-in" class="sec2_img2">
        </div><!--sec2 끝-->

        <div class="sec_area">
          <div class="sec3">
            <h1 class="sec_tit">고객사</h1>
            <img src="images/client.png" data-aos="zoom-in">
       ...
       $( document ).ready( function() {
          ...
          <div class="sec5">
            ...
            <p class="Mnone"><img src="images/process.png" data-aos="zoom-in"></p>
            <p class="Pcnone Tnone"><img src="images/m_process.png" data-aos="zoom-in"></p>
            <p class="Pcnone Tnone"><img src="images/m_process2.png" data-aos="zoom-in"></p>
            <h3>업종, 시즈널, 이슈 등을 파악하여, 최적화된 결과를 도출하는<br>
제이와이네트워크의 8단계 마케팅 프로세스입니다.  </h3>
            <div class="process">
              <img src="images/process_2.png" data-aos="zoom-in">
            </div>
          </div><!--sec5 끝-->
          ...
          <div class="sec6">
            ...
            <img src="images/process_3.png" data-aos="zoom-in">
        ...
        <div class="sec7">
          <img src="images/process_4.png" data-aos="zoom-in" class="Mnone">
          <img src="images/m_process3.png" data-aos="zoom-in" class="Pcnone Tnone">
        </div><!--sec7 끝-->
<!--
        <div class="sec8">
          <h1 class="sec_tit" style="margin-top: 0px;">PATNERS</h1>
          <img src="images/partners.png" data-aos="zoom-in">
        </div> //sec8 끝
-->
        <div class="sec9">
          ...
          <div class="slick">
            <div><a href="https://jynetwork.net/marketing" target="_blank"><img src="images/1.jpg"></a></div>
            <div><a href="https://jy-media.co.kr" target="_blank"><img src="images/2.jpg"></a></div>
            <div><a href="https://jy-design.co.kr" target="_blank"><img src="images/3.jpg"></a></div>
          </div>
          <div class="slick">
            <div><a href="https://jynetwork.net/test" target="_blank"><img src="images/4.jpg"></a></div>
            <div><a href="https://jym.co.kr" target="_blank"><img src="images/5.jpg"></a></div>
            <div><a href="https://jynetwork.net" target="_blank"><img src="images/6.jpg"></a></div>
          </div>
        </div><!--sec9 끝-->
